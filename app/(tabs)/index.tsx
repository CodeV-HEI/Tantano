...
//       <View
//         className={`w-16 h-16 rounded-2xl ${color} items-center justify-center mb-2 shadow-lg shadow-cyan-500/50`}
//       >
//         <MaterialIcons name={icon} size={28} color="white" />
//       </View>
//       <Text className="text-sm text-cyan-300 font-medium tracking-wide neon-text">
//         {title}
//       </Text>
//     </TouchableOpacity>
//   );
...
//         >
//           <Text className="text-cyan-300 text-lg font-medium tracking-wide neon-text">
//             SOLDE TOTAL
//           </Text>
...
//             <Text className="text-xl font-bold text-cyan-300 tracking-wide neon-text">
//               PORTEFEUILLES
//             </Text>
//             <TouchableOpacity onPress={() => router.push("./wallets")}>
//               <Text className="text-cyan-400 font-medium tracking-wide neon-text">
//                 VOIR TOUT
//               </Text>
//             </TouchableOpacity>
//           </View>
...
//                             <View
//                               key={i}
//                               className="bg-cyan-500/10 px-2 py-1 rounded mr-2 mb-1 border border-cyan-500/20"
//                             >
...
export default function Index() {
  return (
    <View className="flex-1 items-center justify-center">
      <Text className="text-xl font-bold">Index Page</Text>
      <Link
        href="/(transactions)/listTransactions"
