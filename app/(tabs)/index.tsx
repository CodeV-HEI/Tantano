...
export default function DashboardScreen() {
  ...
  return (
    ...
    >
      <View
        className={`absolute top-10 -left-20 w-80 h-80 ${theme === "dark" ? "bg-purple-500" : "bg-purple-300"} rounded-full ${theme === "dark" ? "opacity-10" : "opacity-5"} blur-3xl`}
      />
      <View
        className={`absolute bottom-40 -right-20 w-80 h-80 ${theme === "dark" ? "bg-cyan-500" : "bg-cyan-300"} rounded-full ${theme === "dark" ? "opacity-10" : "opacity-5"} blur-3xl`}
      />
