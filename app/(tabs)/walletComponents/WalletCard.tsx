            ...
            <View className="relative mb-3 opacity-50">
                <View className={`${theme === 'dark' ? 'bg-gray-800/50' : 'bg-white'} rounded-2xl p-4 border border-gray-300 dark:border-gray-700`}>
                    <View className="flex-row items-center">
                        <View className="w-12 h-12 rounded-xl mr-3" style={{ backgroundColor: wallet.color || '#cccccc' }} />
                    ...
                    <View className="flex-row items-center">
                        ...
                        <View className="flex-1">
                            ...
                            <View className="flex-row items-center justify-between mt-2">
                                ...
                                <View className={`px-3 py-1 rounded-full`} style={{ backgroundColor: (wallet.color || '#cccccc') + '30' }}>
                                    <Text className={`text-xs font-bold`} style={{ color: wallet.color || '#cccccc' }}>
